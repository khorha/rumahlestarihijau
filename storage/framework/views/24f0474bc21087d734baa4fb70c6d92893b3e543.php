        ...
        <div style="padding: 5%">
            ...
            <div style="text-align:center; width: 50vh;">
                <div id="carousel2" style="margin-top: 10%; margin-bottom: 6%">
                    ...
                    <div ><img src="<?php echo e(Storage::url($culinary->photo)); ?>" style="height:200px; width:200px;" ></div>
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ROG\Downloads\RumahLestariHijau-main\RumahLestariHijau-main\resources\views/home.blade.php ENDPATH**/ ?>