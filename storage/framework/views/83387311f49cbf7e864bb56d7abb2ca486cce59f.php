...
<!-- Promo End -->
  ...
  <div class="row">
    ...
    <div class="col-12" id="carousel" style="margin-top: -8%; margin-bottom: 5%">
        ...
        <div class="slidePromo">
          <img class="col-12" src="<?php echo e(Storage::url($promo->photo)); ?>">
        </div>
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ROG\Downloads\RumahLestariHijau-main\RumahLestariHijau-main\resources\views/homeresp.blade.php ENDPATH**/ ?>