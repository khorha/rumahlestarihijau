...
<div style=" height:fit-content; padding: 40px; ">
    <div style="width: 60%; box-shadow: 1px 2px 4px 6px gray; padding: 3%; float: left; border-radius: 10px">
        <p style="text-align:center; font-size: 150%; font-weight: bold; color: green"><?php echo e($des->name); ?></p>
        <img src="<?php echo e(Storage::url($des->photo)); ?>" style="width: 693px; height: 309px; object-fit: cover;">
        <div class="ets">
        ...
        <div id="Location" style="display:none">
            <div class="mapouter">
                <div class="gmap_canvas"><iframe width="100%" height="510" id="gmap_canvas"
                        src="https://maps.google.com/maps?q=<?php echo e($des->maps); ?>&t=&z=13&ie=UTF8&iwloc=&output=embed"
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ROG\Downloads\RumahLestariHijau-main\RumahLestariHijau-main\resources\views/destinationDetail.blade.php ENDPATH**/ ?>