...
<!-- Promo End -->
    ...
    <div id="carousel" style="margin-top: -10%; margin-bottom: 8%">
        ...
        <div class="slidePromo"><a href="#"><img src="<?php echo e(Storage::url($promo->photo)); ?>" style="height:250px; width:400px;" class="homeImage"></a></div>
        ...
        <div class="row">
          <div class="col-6">
            <h4 class="subTittle" style="text-align: center; font-weight: bold; color: green">
              ...
              <div class="imgContainer">
                  <img src="<?php echo e(Storage::url($destination->photo)); ?>" class="imgService">
          ...
          <div class="col-6">
            <h4 class="subTittle" style="text-align: center; font-weight: bold; color: green">
              ...
              <div class="imgContainer">
                  <img src="<?php echo e(Storage::url($culinary->photo)); ?>"  class="imgService">
                    <a href="/homestay"><button class="serviceButton">See More</button></a>
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ravellaho\Downloads\rumahlestarihijau-master\rumahlestarihijau-master\resources\views/home.blade.php ENDPATH**/ ?>